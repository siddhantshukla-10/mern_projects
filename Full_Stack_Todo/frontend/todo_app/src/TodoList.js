...
import {addTodo, removeTodo, getTodos} from "./actionCreater";
...
class TodoList extends Component{
  ...
  render(){
    let todos = this.props.todos.map(val => <Todo removeTodo={this.removeTodo.bind(this, val._id )} task={val.task} key={val._id}/>)
    return(
      <div>
